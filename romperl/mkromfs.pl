...
sub build_carray {
    ...
    print $out "/* generated by mkromfs.pl --carray from $image. Do not edit. */\n";
    print $out "__attribute__((section(\".romfs\")))\n";
    ...
    print $out "};\n";
    print $out "const unsigned long ${symbol}_size = sizeof(${symbol});\n";
    close $out;
